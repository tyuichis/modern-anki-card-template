...
'object' == typeof exports &&
  ...
  (module.exports =
    hljs); /*! `bash` grammar compiled for Highlight.js 11.9.0 */
(() => {
  var e = (() => {
    'use strict';
    return (e) => {
  ...
  var e = (() => {
    ...
    return (e) => {
      const n = e.regex,
        ...
        m = [c, i, t, e.C_BLOCK_COMMENT_MODE, o, l],
        _ = {
          variants: [
            { begin: /=/, end: /;/ },
            {
        ...
        p = {
          ...
          illegal: /[^\w\s\*&:<>.]/,
          contains: [
            { begin: s, keywords: u, relevance: 0 },
            {
              begin: g,
              returnBegin: !0,
            ...
            { relevance: 0, match: /,/ },
            {
              ...
              contains: [
                ...
                i,
                {
                  ...
                  keywords: u,
                  relevance: 0,
                  contains: ['self', t, e.C_BLOCK_COMMENT_MODE, l, o, i],
                },
              ],
            },
            i,
  ...
  var e = (() => {
    ...
    return (e) => {
      const d = { match: /\s+/, relevance: 0 },
        ...
        A = [e.C_LINE_COMMENT_MODE, h],
        v = { match: [/\./, a(...s, ...c)], className: { 2: 'keyword' } },
        C = { match: t(/\./, a(...r)), relevance: 0 },
        N = r.filter((e) => 'string' == typeof e).concat(['_|0']),
        k = {
          variants: [
            {
              className: 'keyword',
        ...
        G = [
          {
            ...
            starts: {
              contains: [
                { begin: /\(/, end: /\)/, keywords: E, contains: [...M, L, j] },
              ],
            },
          },
          {
      ...
      const X = {
        ...
        Y = {
          match: [/(func|macro)/, /\s+/, a(V.match, w, b)],
          className: { 1: 'keyword', 3: 'title.function' },
          contains: [J, Q, d],
          illegal: [/\[/, /%/],
        },
